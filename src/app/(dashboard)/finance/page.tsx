                    ...
                    <TableRow key={tx.id} className="border-slate-800 hover:bg-slate-800/40">
                      <TableCell className="font-medium">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-slate-500 font-normal">{tx.date}</span>
                        </div>
                      </TableCell>
                      ...
                      <TableCell className={tx.type === 'Income' ? 'text-emerald-400 text-right font-medium' : 'text-slate-100 text-right font-medium'}>
