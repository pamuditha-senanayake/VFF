...
export default function Homepage() {
  ...
  // Task 10: Scroll sensitive Navbar (hide on scroll down, show on scroll up)
  ...
  // Task 9: Scroll Reveal Animations using IntersectionObserver
  ...
  return (
    <div className="min-h-screen bg-[#0B0D12] text-[#F9FAFB] font-sans selection:bg-[#EF9F27]/30 overflow-x-hidden flex flex-col justify-between">

      {/* Navigation Header */}
      <header className={`fixed top-0 left-0 right-0 z-50 border-b border-[#232730] bg-[#0B0D12]/90 backdrop-blur-md transition-transform duration-300 ${
        navVisible ? 'translate-y-0' : '-translate-y-full'
      }`}>
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 h-16 flex justify-between items-center">
          <Link href="/" className="text-sm font-extrabold tracking-wider uppercase text-white hover:text-[#EF9F27] transition-colors">
            VFF IMS
          </Link>
          <nav className="flex items-center gap-6 text-xs font-semibold text-[#9CA3AF]">
      ...
      <main className="flex-grow pt-16">
        ...
        <section id="hero" className={`max-w-[1280px] mx-auto px-6 md:px-12 py-16 space-y-12 transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-white font-heading">
                Empower welfare <br />
              ...
              <div className="flex gap-4 pt-4">
                {isAuthenticated ? (
                  ...
                  <>
                    ...
                    <Link href="/login">
                      <Button variant="outline" className="bg-transparent text-white border-[#232730] hover:bg-white/5 font-bold text-xs py-3 px-6 rounded-lg">
                        System Login
                      </Button>
                    </Link>
                  </>
            ...
            {/* Image column */}
            <div className="relative w-full h-[280px] md:h-[380px] rounded-2xl overflow-hidden border border-[#232730] shadow-2xl bg-surface group">
              <div
          ...
          {/* Stats strip */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-[#232730] pt-12">
            {[
              ...
              <div key={i} className="flex flex-col gap-1 pr-4 border-r border-[#232730]/40 last:border-none">
                <span className="text-2xl md:text-3xl font-extrabold text-white tracking-tight font-heading">{stat.val}</span>
                <span className="text-[9px] font-bold text-[#9CA3AF] uppercase tracking-wider">{stat.label}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* About Section */}
        <section id="about" className={`bg-[#0F1520] border-y border-[#232730] py-20 transition-all duration-1000 ${
          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="h-[280px] md:h-[340px] rounded-xl overflow-hidden border border-[#232730] relative order-2 lg:order-1">
              <div
            ...
            <div className="space-y-6 order-1 lg:order-2">
              <span className="text-[10px] font-bold tracking-wider text-[#9CA3AF] uppercase flex items-center gap-1.5">
                <Heart size={12} className="text-red-500" /> About Vets For Future
              </span>
              <h2 className="text-3xl md:text-4xl font-bold leading-tight tracking-tight text-white font-heading">
        ...
        <section id="impact" className={`max-w-[1280px] mx-auto px-6 md:px-12 py-20 space-y-12 transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#0F1520] border border-[#232730] rounded-xl p-8 space-y-4 hover:border-[#EF9F27]/40 transition-colors">
                <div className={cn("p-3 border rounded-lg w-12 h-12 flex items-center justify-center border-white/5", card.bg, card.color)}>
                  <card.icon size={20} />
                </div>
        ...
        {/* Contact Section */}
        <section id="contact" className={`bg-[#0F1520] border-t border-[#232730] py-20 transition-all duration-1000 ${
          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="h-[280px] md:h-[320px] rounded-xl overflow-hidden border border-[#232730] relative">
              <div
                className="absolute inset-0 bg-cover bg-center"
      ...
      {/* Footer */}
      <footer className="border-t border-[#232730] bg-[#0B0D12] pt-16 pb-8 text-xs text-[#9CA3AF]">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12">
          <div className="space-y-4">
            <span className="text-base font-bold text-white">VFF IMS</span>
          ...
          <div className="space-y-4">
            <span className="font-bold uppercase tracking-wider text-white">System Portals</span>
          ...
          <div className="space-y-4">
            <span className="font-bold uppercase tracking-wider text-white">IMS Modules</span>
            <ul className="space-y-2">
              <li>HR & Attendance</li>
          ...
          <div className="space-y-4">
            <span className="font-bold uppercase tracking-wider text-white">Reach Us</span>
            <ul className="space-y-2">
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 border-t border-[#232730]/60 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[#6B7280]">
